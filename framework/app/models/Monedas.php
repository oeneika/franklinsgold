...
class Monedas extends Models implements IModels {
    ...
    */
    ...
    /** 
      * Crea un elemento de Monedas en la tabla ``
      *
    ...
    */
    final public function add() {
      try {
        ...
        # Insertar elementos
        $this->db->query("INSERT INTO monedas_4
    ...
    /** 
      * Edita un elemento de Monedas en la tabla ``
      *
      * @return array con información para la api, un valor success y un mensaje.
    */
    ...
    /** 
      * Borra un elemento de Monedas en la tabla ``
      * y luego redirecciona a monedas/&success=true
      *
      * @return void
    */
    final public function delete() {
      ...
      $this->db->query("DELETE FROM monedas_4 WHERE id_color = $this->id");
      # Redireccionar a la página principal del controlador
      $this->functions->redir($config['site']['url'] . 'monedas/&success=true');
    }
